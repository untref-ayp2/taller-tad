...
func TestSinglyLinkedListNew(t *testing.T) {
...
func TestSinglyLinkedListRemoveFirstEmpty(t *testing.T) {
	l := NewSinglyLinkedList[int]()
	if l.RemoveFirst() {
...
func TestSinglyLinkedListRemoveLastEmpty(t *testing.T) {
	l := NewSinglyLinkedList[int]()
	if l.RemoveLast() {
...
func TestSinglyLinkedListRemoveHead(t *testing.T) {
	l := NewSinglyLinkedList[int]()
	l.Append(1)
	l.Append(2)
	l.Append(3)
...
func TestSinglyLinkedListRemoveTail(t *testing.T) {
	l := NewSinglyLinkedList[int]()
	l.Append(1)
	l.Append(2)
	l.Append(3)
...
func TestSinglyLinkedListRemoveNonExistent(t *testing.T) {
	l := NewSinglyLinkedList[int]()
	l.Append(1)
	l.Append(2)
	if l.Remove(99) {
...
func TestSinglyLinkedListRemoveOnlyElement(t *testing.T) {
	l := NewSinglyLinkedList[int]()
	l.Append(1)
	l.Remove(1)
	if !l.IsEmpty() {
...
func TestSinglyLinkedListContainsEmpty(t *testing.T) {
	l := NewSinglyLinkedList[int]()
	if l.Contains(1) {
...
func TestSinglyLinkedListValuesEmpty(t *testing.T) {
	l := NewSinglyLinkedList[int]()
	vals := l.Values()
	if len(vals) != 0 {
...
func TestSinglyLinkedListInsertAfterEmpty(t *testing.T) {
	l := NewSinglyLinkedList[int]()
	if l.InsertAfter(1, 2) {
...
func TestSinglyLinkedListInsertBeforeEmpty(t *testing.T) {
	l := NewSinglyLinkedList[int]()
