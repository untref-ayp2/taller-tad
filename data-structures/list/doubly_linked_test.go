...
func TestDoublyLinkedListNew(t *testing.T) {
...
func TestDoublyLinkedListRemoveFirstSingleElement(t *testing.T) {
	l := NewDoublyLinkedList[int]()
	l.Append(1)
	l.RemoveFirst()
	if !l.IsEmpty() {
...
func TestDoublyLinkedListRemoveFirstEmpty(t *testing.T) {
	l := NewDoublyLinkedList[int]()
	if l.RemoveFirst() {
...
func TestDoublyLinkedListRemoveLastEmpty(t *testing.T) {
	l := NewDoublyLinkedList[int]()
	if l.RemoveLast() {
...
func TestDoublyLinkedListRemoveHead(t *testing.T) {
	l := NewDoublyLinkedList[int]()
	l.Append(1)
	l.Append(2)
	l.Append(3)
...
func TestDoublyLinkedListRemoveTail(t *testing.T) {
	l := NewDoublyLinkedList[int]()
	l.Append(1)
	l.Append(2)
	l.Append(3)
...
func TestDoublyLinkedListRemoveNonExistent(t *testing.T) {
	l := NewDoublyLinkedList[int]()
	l.Append(1)
	l.Append(2)
	if l.Remove(99) {
...
func TestDoublyLinkedListContainsEmpty(t *testing.T) {
	l := NewDoublyLinkedList[int]()
	if l.Contains(1) {
...
func TestDoublyLinkedListValuesEmpty(t *testing.T) {
	l := NewDoublyLinkedList[int]()
	vals := l.Values()
	if len(vals) != 0 {
...
func TestDoublyLinkedListInsertAfterTail(t *testing.T) {
	l := NewDoublyLinkedList[int]()
	l.Append(1)
	if !l.InsertAfter(1, 2) {
		t.Error("InsertAfter(1, 2): esperaba true")
...
func TestDoublyLinkedListInsertAfterEmpty(t *testing.T) {
	l := NewDoublyLinkedList[int]()
	if l.InsertAfter(1, 2) {
...
func TestDoublyLinkedListInsertBeforeHead(t *testing.T) {
	l := NewDoublyLinkedList[int]()
	l.Append(2)
...
func TestDoublyLinkedListInsertBeforeEmpty(t *testing.T) {
	l := NewDoublyLinkedList[int]()
